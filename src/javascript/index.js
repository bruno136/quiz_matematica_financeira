...
//Parte do Modal
var icon = document.getElementById('imga');
icon.classList.add("hidden");
icon.addEventListener('click', abrirModal);
///
...
function optionSelected(answer) {
  ...
  if (userAns == correcAns) {
    ...
    scoreTextPoint.innerHTML = userScore * 1;
    ...
    var conteudoParagrafo = document.getElementById('conteudoParagrafo');
    conteudoParagrafo.innerHTML = questions[que_count].resolution;
...
function startTimer(time) {
  ...
  function timer() {
    ...
    if (time < 0) {
      ...
      const allOptions = option_list.children.length; //getting all option items
      let correcAns = questions[que_count].answer; //getting correct answer from array
      //Colocar aqui a parte que se caso o usuário não selecionar nenhuma alternativa aparecer a resolução da questão.
      icon.classList.remove("hidden");
      var conteudoParagrafo = document.getElementById('conteudoParagrafo');
      conteudoParagrafo.innerHTML = questions[que_count].resolution;
      for (i = 0; i < allOptions; i++) {
